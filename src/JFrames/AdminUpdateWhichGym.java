...
/**
 * A class used to either update or delete a gym
 * @author Mr S Malinga(218021100)
 */

public class AdminUpdateWhichGym extends javax.swing.JFrame {

    /**
     * Creates new form AdminUpdateWhichGym
     */
    public AdminUpdateWhichGym() 
    {
        initComponents();
    }

    /**
     * A variable that is entered in the JTextField and tells the program which gym to update or delete
     */
    static int whichGym;
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(lblInvalidID, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    /**
     * A method used to either open the update JFrame or delete a gym when the button enter is pressed
     * @param evt 
     */
    ...
    private void btnHelpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHelpActionPerformed
        JOptionPane.showMessageDialog(null, "Enter the gym ID that you would like to update or delete", "Help", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_btnHelpActionPerformed

    /**
     * A method used to return to the AdminMainMenu JFrame 
     * @param evt 
     */
   ...
   /**
     * A method used to to either update or delete a gym based on whether the variable updateDelete is true or false
     * If updateDelete is true then  the gym will be deleted
     * If updateDelete is false the the gym will be updated 
     */
    ...
    private void updateDelete()
    {
        try 
        {
            try 
            {
                whichGym = Integer.parseInt(txtGymID.getText());
            } 
            catch (Exception ex) 
            {
            ...
            else 
            {
                try 
                {
                    AdminInsertOrUpdateGym update = new AdminInsertOrUpdateGym();
                    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUpdateWhichGym.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminUpdateWhichGym().setVisible(true);
            }
        });
    }
