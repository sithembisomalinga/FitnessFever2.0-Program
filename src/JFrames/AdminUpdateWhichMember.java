...
/**
 * A class used to either update or delete a member
 * @author Mr S Malinga(218021100)
 */

public class AdminUpdateWhichMember extends javax.swing.JFrame {

    /**
     * Creates new form AdminUpdateWhichMember
     */
    public AdminUpdateWhichMember() {
        initComponents();
    }

    /**
     * A variable that is entered in the JTextField and tells the program which member to update or delete
     */
    static int whichMember;
    ...
    private void initComponents() {
        ...
        txtMemberID.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
    ...
    /**
     * A method used to either open the update JFrame or delete a member when the button enter is pressed
     * @param evt 
     */
    ...
    private void btnHelpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHelpActionPerformed
        JOptionPane.showMessageDialog(null, "Enter the member ID that you want updated or deleted.", "Help", JOptionPane.INFORMATION_MESSAGE);
     ...
     * If updateDelete is true then  the member will be deleted
     * If updateDelete is false the the member will be updated 
     */
    ...
    private void updateDelete()
    {
        try 
        {
            try 
            {
                whichMember = Integer.parseInt(txtMemberID.getText());
            } 
            ...
            else 
            {
                ...
                try 
                {
                    AdminInsertOrUpdateMember update = new AdminInsertOrUpdateMember();
                    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUpdateWhichMember.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminUpdateWhichMember().setVisible(true);
            }
        });
    }
